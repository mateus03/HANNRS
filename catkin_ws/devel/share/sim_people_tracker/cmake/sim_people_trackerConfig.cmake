...
if(NOT "/home/amateus/HANNRS/catkin_ws/src/sim_people_tracker/include " STREQUAL " ")
  set(sim_people_tracker_INCLUDE_DIRS "")
  set(_include_dirs "/home/amateus/HANNRS/catkin_ws/src/sim_people_tracker/include")
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'sim_people_tracker' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/amateus/HANNRS/catkin_ws/src/sim_people_tracker/${idir}'.  Ask the maintainer 'mateus <mateus@todo.todo>' to fix it.")
    endif()
