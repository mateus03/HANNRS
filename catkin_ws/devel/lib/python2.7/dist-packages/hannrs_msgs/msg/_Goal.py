"""autogenerated by genpy from hannrs_msgs/Goal.msg. Do not edit."""
import sys
...
class Goal(genpy.Message):
  _md5sum = "f1534f9cbdf89e2a447adf2acc6beaf5"
  _type = "hannrs_msgs/Goal"
...
"""
  __slots__ = ['header','action','person','object','pose']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       header,action,person,object,pose
